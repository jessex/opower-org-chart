...
class EngineersControllerTest < ActionController::TestCase
  ...
  test "should create engineer" do
    assert_difference('Engineer.count') do
      post :create, engineer: { about: @engineer.about, location: @engineer.location, name: @engineer.name, team: @engineer.team }
    end
  ...
  test "should update engineer" do
    put :update, id: @engineer, engineer: { about: @engineer.about, location: @engineer.location, name: @engineer.name, team: @engineer.team }
    assert_redirected_to engineer_path(assigns(:engineer))
  end
